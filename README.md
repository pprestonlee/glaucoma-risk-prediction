...
| Component | URL |
|---|---|
| REST API | `http://YOUR_API_URL` |
| Interactive Docs (Swagger) | `http://YOUR_API_URL/docs` |
| Health Check | `http://YOUR_API_URL/health` |
...
Full deployment in one command from the project root:
```bash
